  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Stack(alignment: Alignment.bottomCenter, children: [
        ...
        if(isGarbageVisible(0)) GarbageWidget(top: 0.1, left: 0.14, size: 0.03, angle: 0.5, asset: "tribotblood_orange"),
        if(isGarbageVisible(8)) GarbageWidget(top: 0.1, left: 0.4, size: 0.05, angle: 0.4, asset: "bottletop_blood"),
        if(isGarbageVisible(2)) GarbageWidget(top: 0.14, left: 0.16, size: 0.06, angle: 5, asset: "bottlebottom_blood"),
